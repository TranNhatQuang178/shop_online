...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="" id="form-create-discount">
                @csrf
                <!-- Default box -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="1" value="1" name="max_uses" id="max-uses" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"  min="1" value="1" name="max_uses_user" id="max_uses_user" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                       ...
                                       <textarea name="description" style="resize:none" id="description" cols="20" rows="5" placeholder="Description" class="form-control"></textarea>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
