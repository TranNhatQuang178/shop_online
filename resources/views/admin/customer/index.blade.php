            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <button class="btn btn-light" onclick="window.location.href = '{{ route('customer.index') }}'">Reset</button>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data="{{ route('customer.delete', $customer->id) }}"
                                            class="text-danger w-4 h-4 mr-1 delete-customer">
