                    ...
                    <div class="card-header">
                        ...
                        <form action="" method="POST" id="form-action">
                            ...
                            <button type="button" class="btn btn-light" name="btn_rest"
                                onclick="window.location.href='{{ route('post.index') }}'">Reset</button>
                            <button name="btn_deleteAll" class="btn btn-danger">Delete Posts</button>
                    </div>
                            ...
                            <tbody>
                                @if ($posts)
                                    @foreach ($posts as $post)
                                        <tr>
                                            <td><input type="checkbox" name="list_check[]" value="{{ $post->id }}"
                                                    id="data-{{ $post->id }}">
                                            </td>
                                            <td>{{ $post->id }}</td>
                                            <td><img src="{{ asset('/images/post/' . $post->image) }}" alt=""
                                                    width="40">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" data="{{ route('post.delete', $post->id) }}"
        ...
        <section class="content-header">
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('postCategory.create') }}" class="btn btn-primary">New Category</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools">
                            <form action="" method="GET" id="search-categoryPost">
                                <div class="input-group input-group" style="width: 250px;">
                                    <input type="text" name="keyword" class="form-control float-right"
                                        placeholder="Search" value="{{ request()->keyword }}">
                            ...
                            <tbody>
                                @if ($categories->isNotEmpty())
                                    @foreach ($categories as $category)
                                        <tr id="data-search">
                                            <td><input type="checkbox" name="list_check[]" value="{{ $category->id }}"
                                                    id="data-{{ $category->id }}">
                                            </td>
                                            <td>{{ $category->id }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('postCategory.edit', $category->id) }}">
                                                    <svg class="filament-link-icon w-4 h-4 mr-1"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                        fill="currentColor" aria-hidden="true">
                                                        <path
                                                ...
                                                <a href="#"
                                                    data="{{ route('postCategory.delete', $category->id) }}"
                                                    class="text-danger w-4 h-4 mr-1 btn-destroy">
                                                    <svg wire:loading.remove.delay="" wire:target=""
                                                        class="filament-link-icon w-4 h-4 mr-1"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
